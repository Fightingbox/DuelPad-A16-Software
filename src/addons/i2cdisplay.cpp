...
void I2CDisplayAddon::process()
{
	...
	case I2CDisplayAddon::DisplayMode::BUTTONS:
		...
		case BUTTON_LAYOUT_STICKLESS:
			//drawStickless(25, 20, 7, 2);
			drawDuelPadStick(10, 20, 7, 2);
			break;
		...
		case BUTTON_LAYOUT_STICKLESSB:
			...
			drawDuelPadStickButtons(28, 20, 7, 2);
			break;
...
void I2CDisplayAddon::drawStickless(int startX, int startY, int buttonRadius, int buttonPadding)
{
	...
	obdPreciseEllipse(&obd, startX, startY+buttonMargin, buttonRadius, buttonRadius, 1, pGamepad->pressedL3());
...
void I2CDisplayAddon::drawSticklessButtons(int startX, int startY, int buttonRadius, int buttonPadding)
{
	...
	obdPreciseEllipse(&obd, startX + (buttonMargin * 5.75), startY + buttonMargin, buttonRadius, buttonRadius, 1, pGamepad->pressedL2());
		...
		obdPreciseEllipse(&obd, startX + (buttonMargin * 3.25), startY + buttonMargin*1.85, buttonRadius, buttonRadius, 1, pGamepad->pressedR3());
}
...
void I2CDisplayAddon::drawDuelPadStick(int startX, int startY, int buttonRadius, int buttonPadding)
{
    const int buttonMargin = buttonPadding + (buttonRadius * 2);
    obdPreciseEllipse(&obd, startX , 										startY +(buttonMargin*0.3), buttonRadius, buttonRadius, 1, pGamepad->pressedL3());
    obdPreciseEllipse(&obd, startX + buttonMargin, 							startY, buttonRadius, buttonRadius, 1, pressedLeft());
    obdPreciseEllipse(&obd, startX + (buttonMargin * 2), 				startY, buttonRadius, buttonRadius, 1, pressedDown());
    obdPreciseEllipse(&obd, startX + (buttonMargin * 2.875), 	startY + (buttonMargin / 2), buttonRadius, buttonRadius, 1, pressedRight());
    obdPreciseEllipse(&obd, startX + (buttonMargin * 3.125), startY + (buttonMargin*2.25), buttonRadius, buttonRadius, 1, pressedUp());

}
void I2CDisplayAddon::drawDuelPadStickButtons(int startX, int startY, int buttonRadius, int buttonPadding)
{
        const int buttonMargin = buttonPadding + (buttonRadius * 2);
    ...
    obdPreciseEllipse(&obd, startX + (buttonMargin * 3.75), startY + buttonMargin - (buttonMargin / 4), buttonRadius, buttonRadius, 1, pGamepad->pressedB2());
    obdPreciseEllipse(&obd, startX + (buttonMargin * 4.75), startY + buttonMargin - (buttonMargin / 4), buttonRadius, buttonRadius, 1, pGamepad->pressedR2());
    obdPreciseEllipse(&obd, startX + (buttonMargin * 5.75), startY + buttonMargin - (buttonMargin / 4), buttonRadius, buttonRadius, 1, pGamepad->pressedL2());

    obdPreciseEllipse(&obd, startX + (buttonMargin * 3), (startY + buttonMargin*1.96), buttonRadius, buttonRadius, 1, pGamepad->pressedR3());
}
