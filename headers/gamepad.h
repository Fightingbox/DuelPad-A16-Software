...
public:
	...
	inline bool __attribute__((always_inline)) pressedM1()    { return pressedButton(GAMEPAD_MASK_M1); }
	inline bool __attribute__((always_inline)) pressedM2()    { return pressedButton(GAMEPAD_MASK_M2); }
