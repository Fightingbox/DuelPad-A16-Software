...
private:
	...
	void drawDuelPadStick(int startX, int startY, int buttonRadius, int buttonPadding);
    void drawDuelPadStickButtons(int startX, int startY, int buttonRadius, int buttonPadding);
	bool pressedUp();
	bool pressedDown();
	bool pressedLeft();
	bool pressedRight();
